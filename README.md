...
Aegis is the second project in a connected quant-finance ecosystem, built on
top of Probatio, a strategy backtesting platform. Aegis reuses Probatio's Parquet/DuckDB price warehouse
as its data source.
